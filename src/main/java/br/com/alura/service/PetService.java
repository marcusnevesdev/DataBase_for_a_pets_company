...
public PetService(ClientHttpConfiguration client) { this.client = client; }
	...
	public void importarPetsDoAbrigo() throws IOException, InterruptedException {
           ...
           while ((line = reader.readLine()) != null) {
               ...
               Pet pet = new Pet(tipo, nome, raca,
            		   			idade, cor, peso);

               String uri = "http://localhost:8080/abrigos/" + idOuNome + "/pets";
               HttpResponse<String> response = client.postRequest(uri, pet);
               int statusCode = response.statusCode();
               String responseBody = response.body();
               if (statusCode == 200) {
